      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              At Santi Sounds, we believe that clear, pristine audio is essential for an immersive worship experience. We deliver solutions that enhance every service, ensuring your message reaches every heart.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div key={feature.title} className="p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
